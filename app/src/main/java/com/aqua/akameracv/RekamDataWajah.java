...
public class RekamDataWajah extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (OpenCVLoader.initDebug()) {
            ...
            Log.i(TAG, "OpenCV terinstal dengan sukses RDW");
        } else {
            // OpenCV tidak terinstal
            Log.e(TAG, "OpenCV tidak terinstal RDW");
        }
        ...
        mulaiButton = findViewById(R.id.button2);
...
//        Size newSize = new Size(inputFrame.rgba().cols() * scaleFactor, inputFrame.rgba().rows() * scaleFactor);
//        Imgproc.resize(inputFrame.rgba(), zoomedFrame, newSize, 0, 0, Imgproc.INTER_LINEAR);
...
//        face_cascade.detectMultiScale(gray, faces, 1.08);
//        face_cascade.detectMultiScale(gray, faces, 1.08, 6, Objdetect.CASCADE_SCALE_IMAGE, new Size(200, 200), new Size(150, 150));
